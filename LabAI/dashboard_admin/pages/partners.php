...
<body>
  ...
  <div class="sidebar d-flex flex-column p-3">
    ...
    <ul class="nav flex-column">
      ...
      <li><a href="partners.php" class="nav-link active"><i class="bi bi-handshake"></i> Partner</a></li>
      ...
      <li><a href="peminjaman.php" class="nav-link"><i class="bi bi-ss"></i> Peminjaman</a></li>
  ...
  <!-- Topbar -->
  <div class="topbar">
    <h5 class="mb-0">Manage Partner</h5>
          ...
          <tbody>
            <?php $no = 1; while($row = pg_fetch_assoc($result)) { ?>
              <tr>
                <td><?= $no++ ?></td>
                <td>
                  <img src="../assets/img/partners/<?= htmlspecialchars($row['logo']) ?>" width="60" height="60" class="rounded-circle border">
                </td>
                <td><?= htmlspecialchars($row['nama']) ?></td>
                <td><?= htmlspecialchars($row['kategori']) ?></td>
                <td>
                  <button 
                    class="btn btn-outline-secondary btn-sm editBtn"
                    data-id="<?= $row['id'] ?>"
                  ...
                  <a href="../actions/delete_partner.php?id=<?= $row['id'] ?>"
  ...
  <div class="modal fade" id="addPartnerModal" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content">
        <form action="../actions/add_partner_action.php" method="POST" enctype="multipart/form-data">
  ...
  <div class="modal fade" id="editPartnerModal" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="../actions/update_partner.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="modal-body">
            ...
            <div class="text-center mb-3">
              <img id="preview_logo" src="" width="80" height="80" class="rounded-circle border shadow-sm">
            </div>
