...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Query PostgreSQL: username dan password terenkripsi (crypt)
    ...
    if (pg_num_rows($result) == 1) {
        ...
        header("Location: view/products.php"); // arahkan ke dashboard
        exit;
    } else {
    ...
    <style>
        ...
        .login-left {
            ...
            background: linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)),
                url('./assets/img/backgorund.jpg') no-repeat center center;
