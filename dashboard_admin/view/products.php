...
<div class="sidebar d-flex flex-column p-3">
    ...
    <ul class="nav flex-column">
        <li><a href="products.php" class="nav-link active"><i class="bi bi-box"></i> Products</a></li>
                ...
                <tbody>
                    ...
                    ?>
                        <tr class="product-row"
                            ...
                            <td><?= $no++ ?></td>
                            <td><img src="../assets/img/products/<?= htmlspecialchars($row['gambar']) ?>" width="50" height="50" class="rounded"></td>
                            ...
                            <td>
                                ...
                                <a href="../controller/delete_products.php?id=<?= $row['id'] ?>"
...
<div class="modal fade" id="addProductModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="../controller/add_product_action.php" method="POST" enctype="multipart/form-data">
...
document.getElementById("searchInput").addEventListener("input", function () {
    ...
    rows.forEach(row => {
        ...
        row.style.display = (nama.includes(keyword) || desk.includes(keyword)) ? "" : "none";
    });
});
</script>
